...
bool my_custom_msgs__msg__path_pose__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_custom_msgs.msg._path_pose.PathPose", full_classname_dest, 38) == 0);
  }
  my_custom_msgs__msg__PathPose * ros_message = _ros_message;
  {  // pose
...
{
  /* NOTE(esteve): Call constructor of PathPose */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_custom_msgs.msg._path_pose");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PathPose");
